...
TRANSLATIONS = {
    "tr": {
        ...
        "cpu_core_usage": "CPU ÇEKİRDEK KULLANIMI",
        "logical_cores": "{count} mantıksal çekirdek",
        "core_label": "Çekirdek {index}",
    ...
    "en": {
        ...
        "cpu_core_usage": "CPU CORE USAGE",
        "logical_cores": "{count} logical cores",
        "core_label": "Core {index}",
